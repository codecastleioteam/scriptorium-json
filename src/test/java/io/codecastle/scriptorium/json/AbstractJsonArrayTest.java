...
public abstract class AbstractJsonArrayTest<A extends JsonArray<A>> {
	...
	public void testWithAllWithArray() throws IOException {
		...
		Assertions.assertEquals(3, capturedObjects.size());
		Assertions.assertEquals(objects[0], capturedObjects.get(0));
		Assertions.assertEquals(objects[1], capturedObjects.get(1));
		Assertions.assertEquals(objects[2], capturedObjects.get(2));
	}
	...
	public void testWithAllWithIterable() throws IOException {
		...
		List<Object> capturedObjects = captor.getAllValues();
		Assertions.assertEquals(3, capturedObjects.size());
		Assertions.assertEquals(objects.get(0), capturedObjects.get(0));
		Assertions.assertEquals(objects.get(1), capturedObjects.get(1));
		Assertions.assertEquals(objects.get(2), capturedObjects.get(2));
	}
	...
	public void testElement() throws IOException {
		...
		Mockito.verifyNoMoreInteractions(scribe);
		Assertions.assertEquals(array, value.then());
	}
	...
	public void testArray() throws IOException {
		...
		Mockito.verifyNoMoreInteractions(scribe);
		Assertions.assertEquals(array, element.then());
	}
	...
	public void testWithConsumer() throws IOException {
		...
		final A result = array.with((a) -> {
			...
			Assertions.assertTrue(a instanceof InscribedJsonArray);
	...
	public void testInscribe() throws IOException {
		...
		final IOFunction<A, FluentNode<A>> inscriptor = (a) -> {
			Assertions.assertEquals(array, a);
			return inscription;
		};
